      	...
      	<div className="col-md-6">
            <div className="card">
                ...
                <div className="card-content">
                    <h4 className="card-title">Send push notification with {Config.pushSettings.pushType=="firebase"?"Firebase":(Config.pushSettings.pushType=="expo"?"Expo":"OneSignal")} {this.state.status}</h4>
