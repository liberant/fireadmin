...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    setSideBG:function(imgeURL){
      $('#theSideBar').css("background-image", "url(/assets/img/"+imgeURL+")");
    },
    ...
    initDocumentationCharts: function(){
        ...
        optionsDailySalesChart = {
            ...
            low: 0,
            high: 50, // Naranjatec: we recommend you to set the high sa the biggest value + something for a better look
    ...
    initDashboardPageCharts: function(){
        ...
        optionsCompletedTasksChart = {
            ...
            low: 0,
            high: 1000, // Naranjatec: we recommend you to set the high sa the biggest value + something for a better look
            chartPadding: { top: 0, right: 0, bottom: 0, left: 0}
        }
